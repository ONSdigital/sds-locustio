...
def delete_firestore_locust_test_data(project_id: str, database_name: str, survey_id: str):
    """
...
def delete_collection_in_batches(collection_ref: firestore.CollectionReference, survey_id: str, batch_size: int):
...
if __name__ == "__main__":
    ...
    delete_firestore_locust_test_data(args.project_id, args.database_name, args.survey_id)
